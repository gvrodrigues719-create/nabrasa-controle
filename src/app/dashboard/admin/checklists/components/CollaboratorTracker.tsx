...
export default function CollaboratorTracker({ collaborators }: CollaboratorTrackerProps) {
        ...
        <div className="bg-white border border-gray-100 rounded-[32px] overflow-hidden shadow-sm">
            ...
            <div className="divide-y divide-gray-50">
                {collaborators.map((worker, i) => {
                    ...
                    return (
                        <div key={i} className="p-5 hover:bg-gray-50 transition-colors flex items-center justify-between group">
